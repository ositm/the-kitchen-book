...
export default function Header() {
  ...
  return (
    <>
      <header className="w-full bg-background/95 backdrop-blur-md sticky top-0 z-40 border-b border-border px-4 py-2.5 sm:px-6 md:px-8 transition-colors">
        <div className="max-w-5xl mx-auto flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1.5 text-xs font-semibold text-foreground/80 bg-card hover:bg-muted border border-border px-3 py-1.5 rounded-full shadow-2xs transition-all"
          ...
          <form onSubmit={handleSearchSubmit} className="hidden sm:flex flex-1 max-w-xs relative">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-1.5 bg-card border border-border rounded-full text-xs text-foreground placeholder:text-muted-foreground font-medium focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary transition-all"
            />
          </form>
            ...
            {user ? (
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 p-1 pl-1 pr-2.5 bg-card hover:bg-muted border border-border rounded-full shadow-2xs transition-all"
                ...
                {showHeaderUserMenu && (
                  <div className="absolute right-0 mt-2 w-48 bg-card border border-border rounded-2xl shadow-xl py-1.5 z-50 animate-in fade-in zoom-in-95 duration-150">
                    ...
                    <button
                      ...
                      className="w-full text-left px-3 py-2 text-xs flex items-center gap-2 text-red-600 hover:bg-red-50 transition-colors border-t border-[#F0ECE3]"
                    >
              ...
              <button
                ...
                className="flex items-center gap-1.5 bg-white hover:bg-sage-light border border-border text-foreground hover:text-primary text-xs font-bold px-3.5 py-1.5 rounded-full shadow-2xs transition-all"
              >
