          ...
          <div className="flex items-center gap-2">
            ...
            {user ? (
              <div className="relative">
                ...
                {showHeaderUserMenu && (
                  <div className="absolute right-0 mt-2 w-48 bg-white border border-border rounded-2xl shadow-xl py-1.5 z-50 animate-in fade-in zoom-in-95 duration-150">
                    <div className="px-3 py-2 border-b border-[#F0ECE3]">
